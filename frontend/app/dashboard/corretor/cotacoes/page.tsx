...
export default function CotacoesCorretorPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-white/50">Gerencie suas cotações de planos de saúde</p>
        </div>
      </div>
      <div className="bg-white/5 border border-white/10 rounded-2xl p-8 text-center">
        <Receipt className="h-12 w-12 text-white/20 mx-auto mb-4" />
        <p className="text-white/40 text-sm">Em breve — módulo de cotações em desenvolvimento</p>
      </div>
    </div>
  );
}
