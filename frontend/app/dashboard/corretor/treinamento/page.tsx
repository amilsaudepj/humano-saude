...
const trilhas = [
  {
    ...
    description: 'Visão guiada do painel do corretor com módulos de CRM, propostas e rotina diária.',
    href: '/dashboard/corretor/treinamento/tour',
    icon: Compass,
    badge: '8 min',
  },
  {
    ...
    description: 'Fluxo comercial e documental para condução completa do lead até proposta.',
    href: '/dashboard/corretor/treinamento/produto',
    icon: BookOpen,
    badge: '18 min',
  },
  {
    ...
    description: 'Argumentação consultiva, leitura de mercado e boas práticas de relacionamento.',
...
export default function CorretorTreinamentoPage() {
  return (
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-2 flex items-center gap-2 text-2xl font-semibold text-white">
              ...
              Central de Treinamento (Corretor)
            </h1>
            <p className="mt-2 max-w-3xl text-sm text-white/65">
              Siga a ordem recomendada para dominar o painel, padronizar atendimento e acelerar fechamento.
            </p>
          </div>
          <Link
            href="/dashboard/corretor/treinamento/tour"
