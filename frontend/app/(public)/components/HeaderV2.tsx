    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-18 lg:h-20 flex items-center justify-between">
          ...
          {/* CTA WhatsApp (sempre) + Hamburger só quando não minimal */}
          <div className="flex items-center gap-3">
            <a
              href="https://wa.me/5521988179407?text=Olá! Gostaria de uma cotação empresarial."
              target="_blank"
              rel="noopener noreferrer"
              className={`inline-flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-lg text-xs font-bold uppercase tracking-wider transition-all hover:-translate-y-0.5 bg-[#B8941F] hover:bg-[#C5A028] text-white ${minimal ? 'flex' : 'hidden lg:inline-flex'}`}
            >
