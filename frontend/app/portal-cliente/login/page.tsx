...
const WHATSAPP_URL = 'https://wa.me/5521988179407?text=Olá!%20Gostaria%20de%20informações%20sobre%20o%20Portal%20do%20Cliente.';
const INSTAGRAM_URL = 'https://instagram.com/humanosauderj';
const CNPJ = '50.216.907/0001-60';
const SUSEP = '251174847';
...
export default function PortalClienteLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <footer className="border-t border-slate-200 bg-slate-50 py-6 px-4">
